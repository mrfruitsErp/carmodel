...
class Vehicle extends Model implements HasMedia
{
    ...
    public function registerMediaCollections(): void {
        ...
        $this->addMediaCollection('libretto')->useDisk('public')->singleFile();
        $this->addMediaCollection('polizza')->useDisk('public')->singleFile();
        $this->addMediaCollection('revisione')->useDisk('public')->singleFile();
        $this->addMediaCollection('altri_documenti')->useDisk('public');
    }
    ...
    public function vehicleDocuments(): HasMany { return $this->hasMany(VehicleDocument::class)->orderByDesc('created_at'); }

    public function documentoAttivo(string $tipo): ?VehicleDocument {
        return $this->vehicleDocuments()->where('tipo', $tipo)->where('attivo', true)->latest()->first();
    }

...
class FleetVehicle extends Model
{
    ...
    protected $fillable = [
        ...
        'web_visible', 'booking_enabled', 'daily_rate_public', 'web_description',
    ];
    ...
    protected $casts = [
        ...
        'daily_rate_public'=> 'decimal:2',
    ];

    public function tenant(): BelongsTo  { return $this->belongsTo(Tenant::class); }
    public function rentals(): HasMany   { return $this->hasMany(Rental::class); }
    public function webBookings(): HasMany { return $this->hasMany(WebBooking::class); }
    ...
    public function getPublicRateAttribute(): float
    {
        return $this->daily_rate_public ?: $this->daily_rate;
    }
    ...
    public function scopeWebVisible($q)        { return $q->where('web_visible', true); }
}
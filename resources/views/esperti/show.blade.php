...
<div class="two-col">
  ...
  <div>
    ...
    <div style="display:flex;gap:8px;margin-top:8px">
      <a href="{{ route('periti.edit', ['esperto' => $esperto->id]) }}" class="btn btn-ghost" style="flex:1;justify-content:center">✎ Modifica</a>
      <form method="POST" action="{{ route('periti.destroy', ['esperto' => $esperto->id]) }}" onsubmit="return confirm('Eliminare questo contatto?')">
        @csrf @method('DELETE')

...
<title>Imposta nuova password — AleCar</title>
...
<div class="login-box">
  ...
  <div class="card">
    ...
    <p class="intro">Imposta la nuova password per accedere al gestionale.</p>
    ...
    <form method="POST" action="{{ route('password.store') }}">
      ...
      <div class="form-group">
        ...
        <input id="password" type="password" name="password" class="form-input" required autocomplete="new-password" placeholder="&bull;&bull;&bull;&bull;&bull;&bull;&bull;&bull;">
        <div class="hint">Minimo 8 caratteri.</div>
      </div>

      <div class="form-group">
        <label class="form-label" for="password_confirmation">Conferma password</label>
        <input id="password_confirmation" type="password" name="password_confirmation" class="form-input" required autocomplete="new-password" placeholder="&bull;&bull;&bull;&bull;&bull;&bull;&bull;&bull;">
      </div>

      <button type="submit" class="btn-primary">Imposta password &rarr;</button>
    </form>

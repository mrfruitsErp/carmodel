...
<title>CarModel Software ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â @yield('title', 'Dashboard')</title>
...
<div class="sidebar">
  <div class="logo">
    ...
    <div class="logo-sub">Software Ãƒâ€šÃ‚Â· Automotive</div>
  </div>
  <nav class="nav">
...
<div class="main">
  ...
  <div class="content">
    @if(session('success'))<div class="alert alert-green"><span>ÃƒÂ¢Ã…â€œÃ¢â‚¬Å“</span><span>{{ session('success') }}</span></div>@endif
    @if(session('warning'))<div class="alert alert-amber"><span>ÃƒÂ¢Ã…Â¡Ã‚Â </span><span>{{ session('warning') }}</span></div>@endif
    @if(session('error'))<div class="alert alert-red"><span>ÃƒÂ¢Ã…â€œÃ¢â‚¬â€</span><span>{{ session('error') }}</span></div>@endif
    @yield('content')
  </div>
</div>
</div>
